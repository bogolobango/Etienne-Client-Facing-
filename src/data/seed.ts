...
// ---------------------------------------------------------------------------
// 5. Appointments, Daily Metrics, Clients — from seed-generator
//    ~150 clients, ~500 appointments over 90 days with realistic patterns
// ---------------------------------------------------------------------------
import { generateSeedData } from './seed-generator'

const _generated = generateSeedData()

export const appointments: Appointment[] = _generated.appointments
export const dailyMetrics: DailyMetrics[] = _generated.dailyMetrics
export const clients: Client[] = _generated.clients
// ---------------------------------------------------------------------------
// 8. Alerts (20 records)
// ---------------------------------------------------------------------------

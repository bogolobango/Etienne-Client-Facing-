...
export const conversations: Conversation[] = [
  ...
  {
    id: 'conv-011', clientName: 'Jessica Taylor', clientPhone: '(212) 555-0111',
  ...
  },
  {
    ...
    transcript: [
      ...
      { role: 'client', content: '5 stars! Dr. Chen was amazing.', timestamp: daysAgoISO(24, 17, 15) },
...
const rawAppointments: RawAppointment[] = [
  ...
  { id: 'apt-003', clientName: 'Sofia Ramirez', clientId: 'cli-003', service: 'Body Contouring', provider: 'PA Johnson', locationId: 'soho', date: daysAgo(0), startTime: '11:00', endTime: '12:30', status: 'confirmed', bookedBy: 'online', noShowRisk: 'medium', room: 3, revenue: 1200 },
  { id: 'apt-004', clientName: 'Janet Cooper', clientId: 'cli-004', service: 'Botox', provider: 'NP Williams', locationId: 'soho', date: daysAgo(0), startTime: '14:00', endTime: '14:30', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-005', clientName: 'Michelle Gonzalez', clientId: 'cli-005', service: 'Hydrafacial', provider: 'PA Johnson', locationId: 'soho', date: daysAgo(0), startTime: '15:00', endTime: '16:00', status: 'confirmed', bookedBy: 'staff', noShowRisk: 'low', room: 4, revenue: 250 },
  { id: 'apt-006', clientName: 'Brittany Scott', clientId: 'cli-006', service: 'Botox', provider: 'Dr. Chen', locationId: 'soho', date: daysAgo(1), startTime: '10:00', endTime: '10:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-007', clientName: 'Vanessa Cruz', clientId: 'cli-007', service: 'Body Contouring', provider: 'PA Johnson', locationId: 'soho', date: daysAgo(1), startTime: '10:00', endTime: '11:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 1200 },
  { id: 'apt-008', clientName: 'Diana Torres', clientId: 'cli-008', service: 'Hydrafacial', provider: 'NP Williams', locationId: 'soho', date: daysAgo(2), startTime: '09:00', endTime: '10:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 5, revenue: 250 },
  { id: 'apt-009', clientName: 'Olivia Martinez', clientId: 'cli-009', service: 'Botox', provider: 'Dr. Chen', locationId: 'soho', date: daysAgo(2), startTime: '11:00', endTime: '11:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-010', clientName: 'Jessica Taylor', clientId: 'cli-010', service: 'Hydrafacial', provider: 'PA Johnson', locationId: 'soho', date: daysAgo(3), startTime: '13:00', endTime: '14:00', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 4, revenue: 250 },
  { id: 'apt-011', clientName: 'Danielle Parker', clientId: 'cli-002', service: 'Chemical Peel', provider: 'NP Williams', locationId: 'soho', date: daysAgo(4), startTime: '09:00', endTime: '09:30', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 2, revenue: 200 },
  { id: 'apt-012', clientName: 'Maria Santos', clientId: 'cli-001', service: 'Laser Hair Removal', provider: 'PA Johnson', locationId: 'soho', date: daysAgo(5), startTime: '14:00', endTime: '14:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 6, revenue: 350 },
  { id: 'apt-013', clientName: 'Sofia Ramirez', clientId: 'cli-003', service: 'Botox', provider: 'Dr. Chen', locationId: 'soho', date: daysAgo(7), startTime: '10:00', endTime: '10:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-014', clientName: 'Janet Cooper', clientId: 'cli-004', service: 'Dermal Filler', provider: 'Dr. Chen', locationId: 'soho', date: daysAgo(8), startTime: '11:00', endTime: '11:45', status: 'cancelled', bookedBy: 'online', noShowRisk: 'medium', room: 2, revenue: 850 },
  { id: 'apt-015', clientName: 'Michelle Gonzalez', clientId: 'cli-005', service: 'Botox', provider: 'NP Williams', locationId: 'soho', date: daysAgo(10), startTime: '15:00', endTime: '15:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-016', clientName: 'Brittany Scott', clientId: 'cli-006', service: 'Chemical Peel', provider: 'PA Johnson', locationId: 'soho', date: daysAgo(12), startTime: '09:00', endTime: '09:30', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 4, revenue: 200 },
  { id: 'apt-017', clientName: 'Vanessa Cruz', clientId: 'cli-007', service: 'Hydrafacial', provider: 'NP Williams', locationId: 'soho', date: daysAgo(14), startTime: '13:00', endTime: '14:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 5, revenue: 250 },
  { id: 'apt-018', clientName: 'Diana Torres', clientId: 'cli-008', service: 'Botox', provider: 'Dr. Chen', locationId: 'soho', date: daysAgo(15), startTime: '10:00', endTime: '10:30', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 1, revenue: 450 },
  { id: 'apt-019', clientName: 'Olivia Martinez', clientId: 'cli-009', service: 'Dermal Filler', provider: 'Dr. Chen', locationId: 'soho', date: daysAgo(18), startTime: '14:00', endTime: '14:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 850 },
  { id: 'apt-020', clientName: 'Jessica Taylor', clientId: 'cli-010', service: 'Body Contouring', provider: 'PA Johnson', locationId: 'soho', date: daysAgo(20), startTime: '09:00', endTime: '10:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 1200 },

  // Williamsburg appointments (rooms 1-4, 2 providers)
  { id: 'apt-021', clientName: 'Emma Johnson', clientId: 'cli-011', service: 'Hydrafacial', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(0), startTime: '09:30', endTime: '10:30', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-022', clientName: 'Michael Brown', clientId: 'cli-012', service: 'Botox', provider: 'NP Kim', locationId: 'williamsburg', date: daysAgo(0), startTime: '11:00', endTime: '11:30', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'medium', room: 2, revenue: 450 },
  { id: 'apt-023', clientName: 'Kayla Nguyen', clientId: 'cli-013', service: 'Body Contouring', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(0), startTime: '13:00', endTime: '14:30', status: 'confirmed', bookedBy: 'online', noShowRisk: 'low', room: 3, revenue: 1200 },
  { id: 'apt-024', clientName: 'Tiffany Ross', clientId: 'cli-014', service: 'Hydrafacial', provider: 'NP Kim', locationId: 'williamsburg', date: daysAgo(1), startTime: '10:00', endTime: '11:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-025', clientName: 'Chris Evans', clientId: 'cli-015', service: 'Botox', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(1), startTime: '14:00', endTime: '14:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 450 },
  { id: 'apt-026', clientName: 'James Richardson', clientId: 'cli-016', service: 'Dermal Filler', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(2), startTime: '09:00', endTime: '09:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 2, revenue: 850 },
  { id: 'apt-027', clientName: 'Angela Wright', clientId: 'cli-017', service: 'Laser Hair Removal', provider: 'NP Kim', locationId: 'williamsburg', date: daysAgo(3), startTime: '11:00', endTime: '11:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 350 },
  { id: 'apt-028', clientName: 'Laura Bennett', clientId: 'cli-018', service: 'Laser Hair Removal', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(4), startTime: '13:00', endTime: '13:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 4, revenue: 350 },
  { id: 'apt-029', clientName: 'Jennifer Lopez', clientId: 'cli-019', service: 'Botox', provider: 'NP Kim', locationId: 'williamsburg', date: daysAgo(5), startTime: '10:00', endTime: '10:30', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 1, revenue: 450 },
  { id: 'apt-030', clientName: 'Robert Davis', clientId: 'cli-020', service: 'Dermal Filler', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(6), startTime: '15:00', endTime: '15:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 2, revenue: 850 },
  { id: 'apt-031', clientName: 'Emma Johnson', clientId: 'cli-011', service: 'Chemical Peel', provider: 'NP Kim', locationId: 'williamsburg', date: daysAgo(8), startTime: '09:00', endTime: '09:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 200 },
  { id: 'apt-032', clientName: 'Kayla Nguyen', clientId: 'cli-013', service: 'Hydrafacial', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(10), startTime: '14:00', endTime: '15:00', status: 'cancelled', bookedBy: 'online', noShowRisk: 'medium', room: 3, revenue: 250 },
  { id: 'apt-033', clientName: 'Chris Evans', clientId: 'cli-015', service: 'Botox', provider: 'NP Kim', locationId: 'williamsburg', date: daysAgo(12), startTime: '11:00', endTime: '11:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 450 },
  { id: 'apt-034', clientName: 'Tiffany Ross', clientId: 'cli-014', service: 'Laser Hair Removal', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(14), startTime: '10:00', endTime: '10:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 4, revenue: 350 },
  { id: 'apt-035', clientName: 'Angela Wright', clientId: 'cli-017', service: 'Botox', provider: 'NP Kim', locationId: 'williamsburg', date: daysAgo(16), startTime: '13:00', endTime: '13:30', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 1, revenue: 450 },
  { id: 'apt-036', clientName: 'Laura Bennett', clientId: 'cli-018', service: 'Hydrafacial', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(20), startTime: '09:00', endTime: '10:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-037', clientName: 'Michael Brown', clientId: 'cli-012', service: 'Chemical Peel', provider: 'NP Kim', locationId: 'williamsburg', date: daysAgo(22), startTime: '15:00', endTime: '15:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 200 },
  { id: 'apt-038', clientName: 'Jennifer Lopez', clientId: 'cli-019', service: 'Dermal Filler', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(25), startTime: '10:00', endTime: '10:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 3, revenue: 850 },

  // Hoboken appointments (rooms 1-4, 3 providers)
  { id: 'apt-039', clientName: 'Priya Patel', clientId: 'cli-021', service: 'Hydrafacial', provider: 'Dr. Okafor', locationId: 'hoboken', date: daysAgo(0), startTime: '11:00', endTime: '12:00', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-040', clientName: 'Sarah Chen', clientId: 'cli-022', service: 'Body Contouring', provider: 'PA Martinez', locationId: 'hoboken', date: daysAgo(0), startTime: '10:00', endTime: '11:30', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 1200 },
  { id: 'apt-041', clientName: 'Lauren White', clientId: 'cli-023', service: 'Chemical Peel', provider: 'NP Garcia', locationId: 'hoboken', date: daysAgo(0), startTime: '15:00', endTime: '15:30', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'medium', room: 3, revenue: 200 },
  { id: 'apt-042', clientName: 'Megan Foster', clientId: 'cli-024', service: 'Laser Hair Removal', provider: 'Dr. Okafor', locationId: 'hoboken', date: daysAgo(1), startTime: '09:00', endTime: '09:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 4, revenue: 350 },
  { id: 'apt-043', clientName: 'Jasmine Washington', clientId: 'cli-025', service: 'Botox', provider: 'PA Martinez', locationId: 'hoboken', date: daysAgo(1), startTime: '14:00', endTime: '14:30', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-044', clientName: 'Lisa Chang', clientId: 'cli-026', service: 'Laser Hair Removal', provider: 'NP Garcia', locationId: 'hoboken', date: daysAgo(2), startTime: '14:00', endTime: '14:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 350 },
  { id: 'apt-045', clientName: 'Catherine Bell', clientId: 'cli-027', service: 'Hydrafacial', provider: 'Dr. Okafor', locationId: 'hoboken', date: daysAgo(3), startTime: '11:00', endTime: '12:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-046', clientName: 'Kevin Murphy', clientId: 'cli-028', service: 'Chemical Peel', provider: 'PA Martinez', locationId: 'hoboken', date: daysAgo(4), startTime: '09:00', endTime: '09:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 200 },
  { id: 'apt-047', clientName: 'Susan White', clientId: 'cli-029', service: 'Chemical Peel', provider: 'NP Garcia', locationId: 'hoboken', date: daysAgo(5), startTime: '10:00', endTime: '10:30', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 3, revenue: 200 },
  { id: 'apt-048', clientName: 'Gregory Hall', clientId: 'cli-030', service: 'Body Contouring', provider: 'Dr. Okafor', locationId: 'hoboken', date: daysAgo(6), startTime: '13:00', endTime: '14:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 1200 },
  { id: 'apt-049', clientName: 'Priya Patel', clientId: 'cli-021', service: 'Botox', provider: 'PA Martinez', locationId: 'hoboken', date: daysAgo(8), startTime: '11:00', endTime: '11:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-050', clientName: 'Sarah Chen', clientId: 'cli-022', service: 'Dermal Filler', provider: 'Dr. Okafor', locationId: 'hoboken', date: daysAgo(10), startTime: '14:00', endTime: '14:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 2, revenue: 850 },
  { id: 'apt-051', clientName: 'Lauren White', clientId: 'cli-023', service: 'Hydrafacial', provider: 'NP Garcia', locationId: 'hoboken', date: daysAgo(12), startTime: '09:00', endTime: '10:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-052', clientName: 'Megan Foster', clientId: 'cli-024', service: 'Botox', provider: 'PA Martinez', locationId: 'hoboken', date: daysAgo(14), startTime: '15:00', endTime: '15:30', status: 'cancelled', bookedBy: 'online', noShowRisk: 'medium', room: 4, revenue: 450 },
  { id: 'apt-053', clientName: 'Jasmine Washington', clientId: 'cli-025', service: 'Chemical Peel', provider: 'Dr. Okafor', locationId: 'hoboken', date: daysAgo(16), startTime: '10:00', endTime: '10:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 200 },
  { id: 'apt-054', clientName: 'Lisa Chang', clientId: 'cli-026', service: 'Laser Hair Removal', provider: 'NP Garcia', locationId: 'hoboken', date: daysAgo(18), startTime: '13:00', endTime: '13:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 350 },
  { id: 'apt-055', clientName: 'Catherine Bell', clientId: 'cli-027', service: 'Dermal Filler', provider: 'PA Martinez', locationId: 'hoboken', date: daysAgo(20), startTime: '11:00', endTime: '11:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 1, revenue: 850 },
  { id: 'apt-056', clientName: 'Kevin Murphy', clientId: 'cli-028', service: 'Botox', provider: 'Dr. Okafor', locationId: 'hoboken', date: daysAgo(22), startTime: '09:00', endTime: '09:30', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 4, revenue: 450 },
  { id: 'apt-057', clientName: 'Susan White', clientId: 'cli-029', service: 'Hydrafacial', provider: 'NP Garcia', locationId: 'hoboken', date: daysAgo(25), startTime: '14:00', endTime: '15:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-058', clientName: 'Gregory Hall', clientId: 'cli-030', service: 'Laser Hair Removal', provider: 'PA Martinez', locationId: 'hoboken', date: daysAgo(28), startTime: '10:00', endTime: '10:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 350 },

  // White Plains appointments (rooms 1-3, 2 providers)
  { id: 'apt-059', clientName: 'David Kim', clientId: 'cli-031', service: 'Chemical Peel', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(0), startTime: '15:00', endTime: '15:30', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 200 },
  { id: 'apt-060', clientName: 'Amy Stewart', clientId: 'cli-032', service: 'Hydrafacial', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(0), startTime: '10:00', endTime: '11:00', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 250 },
  { id: 'apt-061', clientName: 'Nicole Reed', clientId: 'cli-033', service: 'Botox', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(0), startTime: '11:00', endTime: '11:30', status: 'waitlist', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-062', clientName: 'Rachel Green', clientId: 'cli-034', service: 'Dermal Filler', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(1), startTime: '09:00', endTime: '09:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 2, revenue: 850 },
  { id: 'apt-063', clientName: 'Martha Young', clientId: 'cli-035', service: 'Botox', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(1), startTime: '14:00', endTime: '14:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-064', clientName: 'Hannah Lee', clientId: 'cli-036', service: 'Laser Hair Removal', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(2), startTime: '13:00', endTime: '13:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 350 },
  { id: 'apt-065', clientName: 'Samantha Phillips', clientId: 'cli-037', service: 'Botox', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(3), startTime: '10:00', endTime: '10:30', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 1, revenue: 450 },
  { id: 'apt-066', clientName: 'Patricia Collins', clientId: 'cli-038', service: 'Dermal Filler', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(4), startTime: '10:00', endTime: '10:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 850 },
  { id: 'apt-067', clientName: 'Karen Taylor', clientId: 'cli-039', service: 'Laser Hair Removal', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(5), startTime: '15:00', endTime: '15:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 350 },
  { id: 'apt-068', clientName: 'David Kim', clientId: 'cli-031', service: 'Hydrafacial', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(7), startTime: '09:00', endTime: '10:00', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-069', clientName: 'Amy Stewart', clientId: 'cli-032', service: 'Botox', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(9), startTime: '11:00', endTime: '11:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 450 },
  { id: 'apt-070', clientName: 'Nicole Reed', clientId: 'cli-033', service: 'Chemical Peel', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(11), startTime: '14:00', endTime: '14:30', status: 'cancelled', bookedBy: 'online', noShowRisk: 'medium', room: 3, revenue: 200 },
  { id: 'apt-071', clientName: 'Rachel Green', clientId: 'cli-034', service: 'Botox', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(14), startTime: '10:00', endTime: '10:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-072', clientName: 'Martha Young', clientId: 'cli-035', service: 'Hydrafacial', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(17), startTime: '13:00', endTime: '14:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 250 },
  { id: 'apt-073', clientName: 'Hannah Lee', clientId: 'cli-036', service: 'Dermal Filler', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(20), startTime: '09:00', endTime: '09:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 1, revenue: 850 },
  { id: 'apt-074', clientName: 'Samantha Phillips', clientId: 'cli-037', service: 'Laser Hair Removal', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(22), startTime: '15:00', endTime: '15:45', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 3, revenue: 350 },
  { id: 'apt-075', clientName: 'Patricia Collins', clientId: 'cli-038', service: 'Botox', provider: 'Dr. Shah', locationId: 'white-plains', date: daysAgo(25), startTime: '10:00', endTime: '10:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-076', clientName: 'Karen Taylor', clientId: 'cli-039', service: 'Chemical Peel', provider: 'PA Thompson', locationId: 'white-plains', date: daysAgo(28), startTime: '11:00', endTime: '11:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 200 },

  // Stamford appointments (rooms 1-3, 2 providers)
  { id: 'apt-077', clientName: 'Nina Patel', clientId: 'cli-040', service: 'Laser Hair Removal', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(0), startTime: '14:00', endTime: '14:45', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 350 },
  { id: 'apt-078', clientName: 'Amanda Brooks', clientId: 'cli-041', service: 'Dermal Filler', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(0), startTime: '13:00', endTime: '13:45', status: 'confirmed', bookedBy: 'ai', noShowRisk: 'medium', room: 2, revenue: 850 },
  { id: 'apt-079', clientName: 'Sandra Miller', clientId: 'cli-042', service: 'Botox', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(1), startTime: '15:00', endTime: '15:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 450 },
  { id: 'apt-080', clientName: 'Zoe Adams', clientId: 'cli-043', service: 'Chemical Peel', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(1), startTime: '09:00', endTime: '09:30', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 3, revenue: 200 },
  { id: 'apt-081', clientName: 'Rebecca Hill', clientId: 'cli-044', service: 'Chemical Peel', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(2), startTime: '10:00', endTime: '10:30', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 1, revenue: 200 },
  { id: 'apt-082', clientName: 'Heather Morgan', clientId: 'cli-045', service: 'Hydrafacial', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(3), startTime: '14:00', endTime: '15:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 250 },
  { id: 'apt-083', clientName: 'Ryan Cooper', clientId: 'cli-046', service: 'Body Contouring', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(4), startTime: '09:00', endTime: '10:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 1200 },
  { id: 'apt-084', clientName: 'Emily Turner', clientId: 'cli-047', service: 'Chemical Peel', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(5), startTime: '14:00', endTime: '14:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 200 },
  { id: 'apt-085', clientName: 'Christine Hall', clientId: 'cli-048', service: 'Botox', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(6), startTime: '09:00', endTime: '09:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 450 },
  { id: 'apt-086', clientName: 'Ashley Wong', clientId: 'cli-049', service: 'Hydrafacial', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(7), startTime: '11:00', endTime: '12:00', status: 'cancelled', bookedBy: 'online', noShowRisk: 'medium', room: 1, revenue: 250 },
  { id: 'apt-087', clientName: 'Nina Patel', clientId: 'cli-040', service: 'Botox', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(9), startTime: '10:00', endTime: '10:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 450 },
  { id: 'apt-088', clientName: 'Amanda Brooks', clientId: 'cli-041', service: 'Laser Hair Removal', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(11), startTime: '14:00', endTime: '14:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 3, revenue: 350 },
  { id: 'apt-089', clientName: 'Sandra Miller', clientId: 'cli-042', service: 'Hydrafacial', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(13), startTime: '09:00', endTime: '10:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-090', clientName: 'Zoe Adams', clientId: 'cli-043', service: 'Dermal Filler', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(15), startTime: '13:00', endTime: '13:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 850 },
  { id: 'apt-091', clientName: 'Rebecca Hill', clientId: 'cli-044', service: 'Botox', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(17), startTime: '10:00', endTime: '10:30', status: 'no_show', bookedBy: 'online', noShowRisk: 'high', room: 1, revenue: 450 },
  { id: 'apt-092', clientName: 'Heather Morgan', clientId: 'cli-045', service: 'Chemical Peel', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(19), startTime: '15:00', endTime: '15:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 200 },
  { id: 'apt-093', clientName: 'Ryan Cooper', clientId: 'cli-046', service: 'Laser Hair Removal', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(21), startTime: '11:00', endTime: '11:45', status: 'completed', bookedBy: 'staff', noShowRisk: 'low', room: 1, revenue: 350 },
  { id: 'apt-094', clientName: 'Emily Turner', clientId: 'cli-047', service: 'Botox', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(23), startTime: '14:00', endTime: '14:30', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 450 },
  { id: 'apt-095', clientName: 'Christine Hall', clientId: 'cli-048', service: 'Hydrafacial', provider: 'Dr. Shah', locationId: 'stamford', date: daysAgo(25), startTime: '09:00', endTime: '10:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 3, revenue: 250 },
  { id: 'apt-096', clientName: 'Ashley Wong', clientId: 'cli-049', service: 'Dermal Filler', provider: 'NP Garcia', locationId: 'stamford', date: daysAgo(27), startTime: '13:00', endTime: '13:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 850 },

  // A few extra cross-location appointments to reach 100
  { id: 'apt-097', clientName: 'Tom Garcia', clientId: 'cli-050', service: 'Botox', provider: 'Dr. Chen', locationId: 'soho', date: daysAgo(24), startTime: '16:00', endTime: '16:30', status: 'completed', bookedBy: 'online', noShowRisk: 'low', room: 6, revenue: 450 },
  { id: 'apt-098', clientName: 'Tom Garcia', clientId: 'cli-050', service: 'Hydrafacial', provider: 'Dr. Rivera', locationId: 'williamsburg', date: daysAgo(28), startTime: '11:00', endTime: '12:00', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 1, revenue: 250 },
  { id: 'apt-099', clientName: 'Maria Santos', clientId: 'cli-001', service: 'Dermal Filler', provider: 'Dr. Chen', locationId: 'soho', date: daysAgo(26), startTime: '14:00', endTime: '14:45', status: 'completed', bookedBy: 'ai', noShowRisk: 'low', room: 2, revenue: 850 },
...
export const clients: Client[] = [
  ...
  { id: 'cli-010', name: 'Jessica Taylor', email: 'jessica.t@email.com', phone: '(212) 555-0111', preferredLocation: 'soho', totalVisits: 3, clv: 1700, lastVisit: daysAgo(3), joinDate: daysAgo(90), favoriteService: 'Body Contouring', noShowCount: 1 },
...
export const alerts: Alert[] = [
  ...
  },
  {
    ...
    title: 'SoHo provider Dr. Chen nearing capacity',
    description: 'Dr. Chen is booked at 92% for the next 5 business days. Consider routing overflow to PA Johnson or NP Williams.',
